        ...
        <Container size="xl" p={0}>
          <Grid gutter={0} align="stretch">
            <Grid.Col span={{ base: 12, md: 7 }} p={60}>
              <Title order={1} size={52} fw={900} mb={5} c="black">
            ...
            <Grid.Col span={{ base: 12, md: 5 }}>
              <Box
                style={{ height: "100%", minHeight: 450, position: "relative" }}
              >
                <Image
      ...
      <Container size="xl" py={60}>
          ...
          <Grid gutter="xl">
            <Grid.Col span={{ base: 12, md: 6 }}>
              <Paper shadow="md" p={0} radius="lg" withBorder>
                <Box py="md" style={{ borderBottom: "1px solid #eee" }}>
        ...
        <Box py={80} ta="center">
          ...
          <Group justify="center" gap={80} align="center">
            <ActionIcon variant="filled" color="gray" radius="xl" size="xl">
              <IconChevronLeft />
            </ActionIcon>
            ...
            <ActionIcon variant="filled" color="black" radius="xl" size="xl">
              <IconChevronRight />
            </ActionIcon>
          </Group>
        </Box>
